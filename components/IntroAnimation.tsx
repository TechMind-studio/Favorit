...
export default function IntroAnimation() {
  ...
  return (
    <div
      ...
      style={{ transition: 'opacity 0.8s ease', background: '#0a0a0f' }}
    >
      <div className="absolute inset-0 bg-gradient-to-br from-gray-950 via-gray-900 to-primary/10" />

      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full"
        style={{ background: 'radial-gradient(circle, rgba(214,32,39,0.15) 0%, transparent 70%)' }}
      />
