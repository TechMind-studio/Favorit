        ...
        <div className="grid md:grid-cols-2 gap-6">
          {cards.map((card, idx) => {
            ...
            return (
              ...
              <div
                key={card.category}
                className="relative rounded-3xl overflow-hidden flex flex-col justify-between p-6 md:p-10 bg-zinc-900 text-white"
              >
                <span className="absolute -top-4 -left-2 text-[80px] md:text-[160px] font-extrabold font-headline select-none pointer-events-none leading-none text-white/5">
                  {card.category}
                </span>
